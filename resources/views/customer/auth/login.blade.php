  ...
  <div>
    ...
    <div class="form-card">
      <div class="card-heading">
        ...
        <p>Masuk untuk menikmati sajian & kemudahan pesananmu.</p>
      </div>
      ...
      <form action="{{ route('customer.login.store') }}" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="password-field">
            <input type="password" id="login-password" name="password" class="form-input" placeholder="Masukkan kata sandi" required autocomplete="current-password">
      ...
      <div class="bottom-hint">
        Belum punya akun?
        <a href="{{ route('customer.register', $detectedTable ? ['table' => $detectedTable->table_number, 'table_id' => $detectedTable->id] : []) }}">Daftar di sini</a>
      </div>
    </div>
  </div>
